...
import io.jaiclaw.config.McpServerProperties;
import io.jaiclaw.core.mcp.McpToolProvider;
import io.jaiclaw.gateway.mcp.transport.McpTransportFactory;
 ...
 * Reads entries from {@code jaiclaw.mcp-servers.*} and creates transport
...
public class McpServerConfigBootstrap implements SmartInitializingSingleton {
    ...
    public McpServerConfigBootstrap(JaiClawProperties properties, McpServerRegistry registry) {
