 ...
 * validation is handled by jaiclaw-security's Spring Security filter.
 */
public class JwtTenantResolver implements TenantResolver {
    ...
    private Optional<TenantContext> extractTenantFromPayload(String jwt) {
        try {
            ...
            // Simple JSON extraction without a full parser (jaiclaw-core has no Jackson dependency)
     ...
     * Avoids pulling in a JSON parser dependency into jaiclaw-gateway.
     */
