...
class PluginDiscoverySpec extends Specification {
    ...
    static class TestPlugin implements JaiClawPlugin {
        final String id
        final String name
    ...
    static class ToolRegisteringPlugin implements JaiClawPlugin {
        @Override
        PluginDefinition definition() {
    ...
    static class HookRegisteringPlugin implements JaiClawPlugin {
        @Override
        PluginDefinition definition() {
    ...
    static class FailingPlugin implements JaiClawPlugin {
        @Override
        PluginDefinition definition() {
