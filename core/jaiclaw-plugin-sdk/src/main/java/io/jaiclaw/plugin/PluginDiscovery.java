 ...
 * <ol>
 *   <li>Spring component scanning (auto-detected {@link JaiClawPlugin} beans)</li>
 *   <li>ServiceLoader discovery ({@code META-INF/services/io.jaiclaw.plugin.JaiClawPlugin})</li>
...
public class PluginDiscovery {
    ...
    public List<PluginRecord> discoverServiceLoader() {
        ...
        ServiceLoader.load(JaiClawPlugin.class).forEach(plugin -> {
     ...
     */
    public List<PluginRecord> initializeAll(Collection<JaiClawPlugin> plugins, PluginOrigin origin) {
        var records = new ArrayList<PluginRecord>();
        var registered = registeredIds();
     ...
     */
    public PluginRecord initializePlugin(JaiClawPlugin plugin, PluginOrigin origin) {
        var def = plugin.definition();
        try {
