...
public class SecurityModeLogger implements SmartInitializingSingleton {
    ...
    public SecurityModeLogger(JaiClawSecurityProperties properties, ApiKeyProvider apiKeyProvider) {
    ...
    private void logNoneMode() {
        ...
        log.warn("║  Set jaiclaw.security.mode=api-key for API key protection     ║");
        log.warn("║  Set jaiclaw.security.mode=jwt for JWT authentication         ║");
        log.warn("╚══════════════════════════════════════════════════════════════╝");
        log.warn("");
    }
}
