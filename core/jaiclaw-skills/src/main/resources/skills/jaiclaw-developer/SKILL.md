...
- **Dual tool bridge**: JaiClaw `ToolCallback` SPI ↔ Spring AI `ToolCallback` via `SpringAiToolBridge`
...
- **Workspace skills**: Place in `.jaiclaw/skills/{name}/SKILL.md` — loaded from configured `jaiclaw.skills.workspace-dir`
