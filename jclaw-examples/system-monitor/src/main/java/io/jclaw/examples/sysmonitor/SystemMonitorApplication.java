 ...
 * <ul>
 *   <li>{@code jclaw-starter-gateway} — REST + WebSocket + Telegram channel</li>
 *   <li>{@code jclaw-starter-cron} — embedded cron manager with MCP tools, batch, H2 persistence</li>
