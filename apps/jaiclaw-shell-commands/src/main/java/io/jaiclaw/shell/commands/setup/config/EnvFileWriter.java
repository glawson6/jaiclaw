...
public class EnvFileWriter {
    ...
    public String generate(OnboardResult result) {
        ...
        sb.append("# JaiClaw secrets - generated by setup wizard\n");
        sb.append("# Source this file before running JaiClaw: source ").append(
                ConfigLocation.envFile(result.configDir())).append("\n\n");

        // Security
        sb.append("# Security\n");
        sb.append("export JAICLAW_SECURITY_MODE=").append(result.securityMode()).append("\n");
        if ("api-key".equals(result.securityMode()) && result.apiKey() != null && !result.apiKey().isBlank()) {
            sb.append("export JAICLAW_API_KEY=").append(result.apiKey()).append("\n");
        }
        sb.append("\n");
