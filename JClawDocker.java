...
/**
 * JClaw Docker Launcher — JBang script for Docker-based deployment.
 *
 * Uses Docker Compose via the docker CLI to manage the gateway container.
 *
 * Usage:
 *   jbang JClawDocker.java              # start gateway via Docker Compose (default)
 *   jbang JClawDocker.java gateway      # start gateway via Docker Compose
 *   jbang JClawDocker.java cli          # start interactive CLI shell (Docker)
 *   jbang JClawDocker.java telegram     # validate Telegram token → start gateway (Docker)
 *   jbang JClawDocker.java stop         # stop Docker Compose stack
 *   jbang JClawDocker.java logs         # tail gateway container logs
 *   jbang JClawDocker.java help         # print usage
 */
public class JClawDocker {
    ...
    public static void main(String[] args) throws Exception {
        ...
        switch (command) {
            ...
            default -> {
                ...
                System.out.println("Run 'jbang JClawDocker.java help' for usage.");
                System.exit(1);
            }
        }
    }
    ...
    static void cmdGateway() throws Exception {
        ...
        System.out.printf("  %sjbang JClawDocker.java logs%s%n", BOLD, NC);
        System.out.println();
        System.out.println("Stop:");
        System.out.printf("  %sjbang JClawDocker.java stop%s%n", BOLD, NC);
        System.out.println();
    ...
    static void printHelp() {
        System.out.println("Usage: jbang JClawDocker.java [command]");
        System.out.println();
        ...
        System.out.println();
        System.out.println("For local (no Docker) deployment, use: jbang JClaw.java");
    }
    ...
    static void ensureImage(String module) throws Exception {
        String image = "io.jclaw/" + module + ":0.1.0-SNAPSHOT";
