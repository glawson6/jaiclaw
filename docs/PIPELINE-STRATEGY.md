...
|---|---|
| `docs/ARCHITECTURE.md` § High-Level Architecture | Layer placement for jaiclaw-pipeline |
| `docs/ARCHITECTURE.md` § Extension Modules | Registration of jaiclaw-pipeline module |
| `docs/OPERATIONS.md` § Skills Configuration | Parallel pattern for pipeline configuration |
| `docs/OPERATIONS.md` § Prerequisites | Java 21 + Camel requirements |
