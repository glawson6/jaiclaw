#!/usr/bin/env bash
#
# Regenerate the 8-module Agent Blueprint ASCII diagrams from JSON scene
# specs. Runs the JaiClaw ASCII renderer via JBang, writes .txt siblings
# for inline inclusion in BUILDING-AGENTS.md.
#
# Usage: ./render.sh                              # regenerate all
#        ./render.sh agent-blueprint-hub          # regenerate one
