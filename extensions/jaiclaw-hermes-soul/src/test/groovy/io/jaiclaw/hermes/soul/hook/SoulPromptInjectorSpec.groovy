package io.jaiclaw.hermes.soul.hook
...
class SoulPromptInjectorSpec extends Specification {
    ...
    HermesSoulProperties propsWithTenant() {
        new HermesSoulProperties(true, null, new HermesSoulProperties.Rest(false),
                new HermesSoulProperties.Tenant(true, List.of("ADMIN", "OPERATOR")))
    }

    HermesSoulProperties propsTenantDisabled() {
        new HermesSoulProperties(true, null, new HermesSoulProperties.Rest(false),
                new HermesSoulProperties.Tenant(false, List.of("ADMIN", "OPERATOR")))
    }
    ...
    def "tenant scope skipped when jaiclaw.hermes.soul.tenant.enabled=false"() {
        given:
