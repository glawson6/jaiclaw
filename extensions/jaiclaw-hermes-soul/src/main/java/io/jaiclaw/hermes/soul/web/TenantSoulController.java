 ...
 * {@code jaiclaw.hermes.soul.tenant.write.roles} (default
 * {@code [ADMIN, OPERATOR]}). All endpoints gated by
 * {@code jaiclaw.hermes.soul.tenant.enabled=true}.
 *
 * <p>Plan §5 task 1.16. Tenant Soul writes never go through the agent tool
 * (see {@link io.jaiclaw.hermes.soul.tool.SoulAgentTool}) — this controller
 ...
 */
@RestController
@RequestMapping("/api/hermes/soul/tenant")
