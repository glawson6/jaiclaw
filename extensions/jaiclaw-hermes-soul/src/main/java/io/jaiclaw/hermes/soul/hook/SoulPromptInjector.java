 ...
 * <ol>
 *   <li>TENANT-scope Soul (when {@code jaiclaw.hermes.soul.tenant.enabled=true}
...
public class SoulPromptInjector implements JaiClawPlugin {
    ...
    private final HermesSoulProperties props;
    ...
    public PluginDefinition definition() {
        return PluginDefinition.builder()
                .id("hermes-soul-prompt-injector")
                .name("Hermes Soul Prompt Injector")
