...
/**
 * Default {@link HermesUserKeyResolver}. Delegates to
 ...
 */
public class IdentityLinkUserKeyResolver implements HermesUserKeyResolver {
    ...
    public IdentityLinkUserKeyResolver(IdentityResolver identityResolver) {
        ...
        if (identityResolver == null) {
            log.warn("HermesUserKeyResolver: jaiclaw-identity not on classpath — "
