package io.jaiclaw.agentmind.soul.metrics;
 ...
 *       (success|conflict).</li>
 *   <li>{@code jaiclaw.agentmind.soul.conflicts{scope}} — stale-version
...
public class InstrumentedSoulProvider implements SoulProvider {
    ...
    private Counter conflicts(SoulScope scope) {
        return Counter.builder("jaiclaw.agentmind.soul.conflicts")
