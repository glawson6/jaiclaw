package io.jaiclaw.agentmind.soul.mcp;
 ...
 * {@code agentmind-soul-tenant-admin}.
 *
 ...
 * MCP clients connect to {@code agentmind-soul-tenant-admin}; general clients
 * connect only to {@code agentmind-soul}.
 *
 * <p>Plan §5 task 1.16.
 */
public class TenantSoulMcpToolProvider implements McpToolProvider {

    private static final String SERVER_NAME = "agentmind-soul-tenant-admin";
    private static final String SERVER_DESCRIPTION =
            "AgentMind Soul tenant-scope write — operator-only, restrict to admin MCP clients";
