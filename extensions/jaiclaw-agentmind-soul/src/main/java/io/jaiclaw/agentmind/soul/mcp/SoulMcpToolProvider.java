...
/**
 * MCP tool provider for Soul reads. Server name: {@code agentmind-soul}.
 * Two tools:
 *
 * <ul>
...
public class SoulMcpToolProvider implements McpToolProvider {
    ...
    private static final String SERVER_NAME = "agentmind-soul";
    private static final String SERVER_DESCRIPTION =
            "AgentMind Soul read access — markdown personality overlay spliced into the system prompt";
