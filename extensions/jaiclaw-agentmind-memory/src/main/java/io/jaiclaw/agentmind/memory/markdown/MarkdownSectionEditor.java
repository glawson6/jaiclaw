 ...
 * ({@code # Notes}, {@code # Outages}, etc.) and supports add / replace /
 * remove by heading.
 *
 ...
 *
 * <p><b>Duplicated</b> from
 * {@code io.jaiclaw.agentmind.soul.markdown.MarkdownSectionEditor}. Both
 * pillars share the editor by value, not by dependency — depending on the
 * soul module would couple Memory's deployability to a pillar it does not
 * functionally need. When Phase 3 (Tendencies) hits this same call-site
 * (the third copy), this class should be extracted to
 * {@code jaiclaw-tools} or a new shared module.
 *
 * <p>Plan §6 task 2.5 (memory agent tool).
 */
