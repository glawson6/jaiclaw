...
/**
 * Default {@link WebErrorLogger} for the WebMVC autoconfig. Follows
 ...
 */
public class Slf4jMvcWebErrorLogger implements WebErrorLogger {

    private static final Logger log = LoggerFactory.getLogger(Slf4jMvcWebErrorLogger.class);
