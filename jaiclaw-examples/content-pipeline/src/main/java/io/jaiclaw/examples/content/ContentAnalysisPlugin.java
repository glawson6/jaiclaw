package io.jaiclaw.examples.content;
 ...
 * Demonstrates the JaiClawPlugin SPI with multiple tool registrations.
 */
@Component
public class ContentAnalysisPlugin implements JaiClawPlugin {
